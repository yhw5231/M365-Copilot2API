...
var builtInModelPrices = map[string]modelPrice{
	...
	"gpt-5.4-mini":            {InputPerMillion: 2.50, CachedInputPerMillion: 0.250, OutputPerMillion: 15.00, Currency: "USD", Estimated: true},
	...
	"gpt-5.6":                 {InputPerMillion: 2.50, CachedInputPerMillion: 0.250, OutputPerMillion: 15.00, Currency: "USD", Estimated: true},
	"gpt-5.6-reasoning":       {InputPerMillion: 2.50, CachedInputPerMillion: 0.250, OutputPerMillion: 15.00, Currency: "USD", Estimated: true},
	"gpt-5.6-sol":             {InputPerMillion: 2.50, CachedInputPerMillion: 0.250, OutputPerMillion: 15.00, Currency: "USD", Estimated: true},
	"gpt-5.6-terra":           {InputPerMillion: 2.50, CachedInputPerMillion: 0.250, OutputPerMillion: 15.00, Currency: "USD", Estimated: true},
	"gpt-5.6-luna":            {InputPerMillion: 2.50, CachedInputPerMillion: 0.250, OutputPerMillion: 15.00, Currency: "USD", Estimated: true},
